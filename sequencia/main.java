class Main {
    public static void main(String[] args){
        ...
        System.out.println(seq.before(seq.last()));
        System.out.println(seq.after(seq.first()));
        System.out.println(seq.replaceAtRank(2, 423));
        System.out.println(seq.elemAtRank(2));
        seq.swapElements(3, 9);
        for(int i = 0; i < seq.size(); i++){
            System.out.println(seq.elemAtRank(i));
        }
        System.out.println(seq.replaceAtRank(2, 2));
        seq.removeAtRank(4);

        for(int i = 0; i < seq.size(); i++){
            System.out.println(seq.elemAtRank(i));
        }
        seq.insertAtRank(4, 4);
        for(int i = 0; i < seq.size(); i++){
            System.out.println(seq.elemAtRank(i));
        }
        seq.insertAfter(4, 8);
        seq.insertBefore(4, 2);
        for(int i = 0; i < seq.size(); i++){
            System.out.println(seq.elemAtRank(i));
        }
        seq.remove(4);
    ...
    public boolean isFirst(Object o){
     ...
     public void swapElements(Object p, Object q){
        ...
        if(aux1 != null && aux2 != null){
            ...
            aux2.setElemento(p1);
            if(aux1 == last) last = aux1;
            
            if(aux2 == last) last = aux2;
            
            if(aux1 == first) first = aux1;

            if(aux2 == first) first = aux2;
        }
     }
